...
const labs = [
  { id: 'volatile-data-collection', title: 'Volatile Data Collection', category: 'Forensics', difficulty: 'Easy', image: { src: 'https://picsum.photos/600/400?random=1', hint: 'terminal commands' } },
  { id: 'analyzing-memory-dumps', title: 'Analyzing Memory Dumps', category: 'Memory Forensics', difficulty: 'Medium', image: { src: 'https://picsum.photos/600/400?random=2', hint: 'hexadecimal data' } },
  { id: 'ntfs-forensics', title: 'NTFS Forensics', category: 'File System Forensics', difficulty: 'Hard', image: { src: 'https://picsum.photos/600/400?random=3', hint: 'file system structure' } },
  { id: 'packet-capture-analysis', title: 'Packet Capture Analysis', category: 'Network Forensics', difficulty: 'Medium', image: { src: 'https://picsum.photos/600/400?random=4', hint: 'network traffic graph' } },
  { id: 'log-analysis', title: 'Log Analysis', category: 'Incident Response', difficulty: 'Easy', image: { src: 'https://picsum.photos/600/400?random=5', hint: 'server log files' } },
  { id: 'malware-triage', title: 'Malware Triage', category: 'Malware Analysis', difficulty: 'Hard', image: { src: 'https://picsum.photos/600/400?random=6', hint: 'disassembled code' } },
];
...
const ctfs = [
    {
        ...
        image: { src: 'https://picsum.photos/800/400?random=11', hint: 'detective board' },
        status: 'live',
    },
    {
